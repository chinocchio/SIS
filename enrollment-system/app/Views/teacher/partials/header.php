...
<header class="top-header">
    <a href="/teacher/dashboard" class="header-brand">
        👨‍🏫 RNTVS Teacher
    </a>
    ...
    <div class="teacher-profile">
        <button class="profile-btn" id="profileBtn" onclick="toggleProfileDropdown()">
            <div class="profile-avatar">
                <?php 
                $teacherName = session()->get('first_name', 'Teacher') . ' ' . session()->get('last_name', '');
                $initials = strtoupper(substr($teacherName, 0, 1));
                echo $initials;
                ?>
            </div>
            <div class="profile-info">
                <span class="profile-name"><?= esc($teacherName) ?></span>
        ...
        <div class="profile-dropdown" id="profileDropdown">
            <div class="dropdown-header">
                <p class="dropdown-header-name"><?= esc($teacherName) ?></p>
                <p class="dropdown-header-email"><?= esc(session()->get('email') ?? 'teacher@sis.com') ?></p>
            </div>
            
            <a href="/index.php/teacher/change-password" class="dropdown-item">
                <span>🔒</span>
