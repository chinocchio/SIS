...
<header class="top-header">
    <a href="/student/dashboard" class="header-brand">
        🎓 RNTVS Student
    </a>
    ...
    <div class="student-profile">
        <button class="profile-btn" id="profileBtn" onclick="toggleProfileDropdown()">
            ...
            <div class="profile-info">
                <span class="profile-name"><?= esc($studentName) ?></span>
        ...
        <div class="profile-dropdown" id="profileDropdown">
            <div class="dropdown-header">
                <p class="dropdown-header-name"><?= esc($studentName) ?></p>
                <p class="dropdown-header-email"><?= esc($student['email'] ?? 'student@sis.com') ?></p>
            </div>
            
            <a href="/student/change-password" class="dropdown-item">
                <span>🔒</span>
